...
class Catalogue:
    """
    The Catalogue class is responsible for the addition, removal, search, checkout,
    ...
    def add_item(self, item):
        """
        Adds an item to the item list. Uses classes from ItemListGenerator to determine whether it is a book,
        dvd or journal item.
        :param item: a list
        ...
        while True:
            ...
            if choice == 1:
                item = Book(input("Enter title: "), int(input("Enter call number: ")), input("Enter author: "),
                            int(input("Enter number of copies: ")))
            if choice == 2:
                item = Dvd(input("Enter title"), int(input("Enter call number: ")), input("Enter author"),
                           int(input("Enter number of copies: ")), input("Enter release date: "),
                           int(input("Region Code: ")))
            if choice == 3:
                item = Journal(input("Enter title: "), int(input("Enter call number: ")), input("Enter author:"),
                               int(input("Enter number of copies: ")), input("Enter name: "),
                               int(input("Enter issue number: ")), input("Enter publisher: "))
            if choice == 4:
                break
    ...
    def remove_item(self, call_number):
        ...
        for item in self.item_list:
            if call_number == item.get_call_number() and item.check_availability():
